...
@TestPropertySource(properties = {// On remplace les serveurs Kafka par le broker embarqué pour isoler le test
...
public class LibraryEventsConsumerIT {
    ...
    void publishNewLibraryEvent() throws ExecutionException, InterruptedException, JsonProcessingException {
        ...
        verify(libraryEventsServiceSpy, atLeastOnce()).processLibraryEvent(isA(ConsumerRecord.class));
